ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.centrifuge('sourcium_centrifuge')
        ...
        .chancedOutput('1x gtceu:small_sourcium_dust', 5000, 500)
        .chancedOutput('1x gtceu:small_sourcium_dust', 1000, 200)
        .duration(70)
        .EUt(120)
    event.recipes.gtceu.centrifuge('soulium_centrifuge')
        .inputFluids(Fluid.of('gtceu:soulium', 250))
        .itemOutputs('1x gtceu:soulium_dust')
        .chancedOutput('1x gtceu:small_soulium_dust', 5000, 500)
        .chancedOutput('1x gtceu:small_soulium_dust', 1000, 200)
        .duration(70)
        .EUt(120)
    ...
    event.recipes.gtceu.source_reactor('warp_scroll')
        .itemInputs('16x gtceu:exquisite_arcane_crystal_gem', '4x gtceu:zpm_field_generator', '1x ars_nouveau:blank_parchment')
        .inputFluids(Fluid.of('gtceu:sourcium', 16000))
        .itemOutputs('1x ars_nouveau:warp_scroll')
        .duration(540)
        .EUt(122880)
    event.remove({ id: 'ars_nouveau:stable_warp_scroll' })
    event.recipes.gtceu.source_reactor('stable_warp_scroll')
        .itemInputs('1x kubejs:ultimate_ingot', '1x gtceu:gravi_star', '1x ars_nouveau:warp_scroll')
        .inputFluids(Fluid.of('gtceu:sourcium', 64000))
    ...
    event.recipes.gtceu.source_reactor('soul_star_to_nether_star')
        .itemInputs('1x bosses_of_mass_destruction:soul_star', '4x #forge:dusts/nether_quartz')
        .inputFluids(Fluid.of('gtceu:sourcium', 16000))
    ...
    //magic_fuel
    event.recipes.gtceu.source_reactor('magic_fuel')
        .itemInputs('1x ars_nouveau:fire_essence', '1x gtceu:arcane_crystal_gem', '1x minecraft:blaze_powder')
        .inputFluids(Fluid.of('gtceu:sourcium', 4000))
        .itemOutputs('1x kubejs:magic_fuel')
        .duration(90)
        .EUt(1920)
})