ServerEvents.recipes(event => {
    ...
    */
    ...
    event.recipes.gtceu.macerator('clear_shard_recycle')
        ...
        .duration(50)
        .EUt(2)
    event.recipes.gtceu.compressor('magic_fuel_compress')
        .itemInputs('9x kubejs:magic_fuel')
        .itemOutputs('1x kubejs:magic_fuel_block')
        .duration(300)
        .EUt(2)
    event.recipes.gtceu.forge_hammer('magic_fuel_forge_hammer')
        .itemInputs('1x kubejs:magic_fuel_block')
        .itemOutputs('9x kubejs:magic_fuel')
        .duration(100)
        .EUt(24)
/*    
...
*/
    ...
    event.recipes.gtceu.macerator('moon_stone_macerator')
        .itemInputs('1x ad_astra:moon_stone')
        .itemOutputs('1x gtceu:moon_stone_dust')
        .duration(182)
        .EUt(2)
    event.recipes.gtceu.macerator('moon_cobblestone_macerator')
    ...
    event.recipes.gtceu.macerator('mars_stone_macerator')
        .itemInputs('1x ad_astra:mars_stone')
        .itemOutputs('1x gtceu:mars_stone_dust')
        .duration(214)
        .EUt(2)
    event.recipes.gtceu.macerator('mars_cobblestone_macerator')
    ...
    event.recipes.gtceu.macerator('venus_stone_macerator')
        .itemInputs('1x ad_astra:venus_stone')
        .itemOutputs('1x gtceu:venus_stone_dust')
        .duration(246)
        .EUt(2)
    event.recipes.gtceu.macerator('venus_cobblestone_macerator')
    ...
    event.recipes.gtceu.macerator('mercury_stone_macerator')
        .itemInputs('1x ad_astra:mercury_stone')
        .itemOutputs('1x gtceu:mercury_stone_dust')
        .duration(250)
        .EUt(2)
    event.recipes.gtceu.macerator('mercury_cobblestone_macerator')
    ...
    event.recipes.gtceu.macerator('glacio_stone_macerator')
        .itemInputs('1x ad_astra:glacio_stone')
        .itemOutputs('1x gtceu:glacio_stone_dust')
        .duration(314)
        .EUt(2)
    event.recipes.gtceu.macerator('glacio_cobblestone_macerator')
