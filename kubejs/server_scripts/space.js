ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler('nasa_workbench')
        .itemInputs('15x gtnn:heavy_plate_t1', '4x #gtceu:circuits/ev', '4x gtceu:hv_robot_arm', '4x #forge:rods/long/stainless_steel', '1x #forge:storage_blocks/stainless_steel')
        .itemOutputs('1x ad_astra:nasa_workbench')
    ...
    event.recipes.gtceu.assembler('automation_nasa_workbench')
        .itemInputs('8x gtnn:heavy_plate_t2', '2x #gtceu:circuits/iv', '4x gtceu:ev_conveyor_module', '1x ad_astra:nasa_workbench')
        .itemOutputs('1x ad_astra_giselle_addon:automation_nasa_workbench')
        .inputFluids(Fluid.of('gtceu:polytetrafluoroethylene', 576))
        .duration(460)
        .EUt(1920)
    event.remove({ id: 'ad_astra_giselle_addon:crafting/fuel_loader' })
    event.recipes.gtceu.assembler('fuel_loader')
        .itemInputs('6x gtnn:heavy_plate_t2', '2x #gtceu:circuits/ev', '4x gtceu:ev_electric_pump', '1x gtceu:ev_machine_hull')
        .itemOutputs('1x ad_astra_giselle_addon:fuel_loader')
        .inputFluids(Fluid.of('gtceu:polytetrafluoroethylene', 576))
        .duration(460)
        .EUt(1920)
    event.remove({ id: 'ad_astra_giselle_addon:crafting/gravity_normalizer' })
    event.recipes.gtceu.assembler('gravity_normalizer')
        .itemInputs('6x gtnn:heavy_plate_t3', '2x #gtceu:circuits/luv', '2x gtceu:luv_sensor', '2x gtceu:luv_field_generator')
        .itemOutputs('1x ad_astra_giselle_addon:gravity_normalizer')
        .inputFluids(Fluid.of('gtceu:polybenzimidazole', 576))
        .duration(620)
        .EUt(7680)
    event.remove({ id: 'ad_astra:gravity_normalizer' })
    event.recipes.gtceu.assembler('gravity_normalizer_advanced')
        .itemInputs('8x gtnn:heavy_plate_t3', '4x #gtceu:circuits/zpm', '4x gtceu:zpm_sensor', '4x gtceu:zpm_field_generator', '1x avaritia:crystal_matrix', '1x ad_astra_giselle_addon:gravity_normalizer')
        .itemOutputs('1x ad_astra:gravity_normalizer')
    ...
    event.recipes.gtceu.rocket_engine('cryo_fuel_generator')
        ...
        .duration(6)
        .EUt(-2048)
    event.recipes.gtceu.rocket_engine('advanced_cryo_fuel_generator')
        .inputFluids(Fluid.of('gtceu:advanced_cryo_fuel', 1))
        .duration(24)
        .EUt(-2048)
    ...
    event.recipes.gtceu.macerator('mutant_skeleton_skull_macerator')
        .itemInputs('1x mutantmonsters:mutant_skeleton_skull')
        .itemOutputs('8x minecraft:bone_meal')
        .chancedOutput('1x gtceu:titanium_dust', 4000, 100)
        .duration(240)
        .EUt(2)
    event.recipes.gtceu.macerator('mutant_skeleton_limb_macerator')
        .itemInputs('1x mutantmonsters:mutant_skeleton_limb')
        .itemOutputs('3x minecraft:bone_meal')
        .chancedOutput('1x gtceu:titanium_dust', 1500, 100)
        .duration(90)
        .EUt(2)
    event.recipes.gtceu.macerator('mutant_skeleton_pelvis_macerator')
        .itemInputs('1x mutantmonsters:mutant_skeleton_pelvis')
        .itemOutputs('4x minecraft:bone_meal')
        .chancedOutput('1x gtceu:titanium_dust', 2000, 100)
        .duration(150)
        .EUt(2)
    event.recipes.gtceu.macerator('mutant_skeleton_rib_macerator')
        .itemInputs('1x mutantmonsters:mutant_skeleton_rib')
        .itemOutputs('2x minecraft:bone_meal')
        .chancedOutput('1x gtceu:titanium_dust', 1000, 100)
        .duration(60)
        .EUt(2)
    event.recipes.gtceu.macerator('mutant_skeleton_shoulder_pad_macerator')
        .itemInputs('1x mutantmonsters:mutant_skeleton_shoulder_pad')
        .itemOutputs('3x minecraft:bone_meal')
        .chancedOutput('1x gtceu:titanium_dust', 1500, 100)
        .duration(90)
        .EUt(2)
    ...
    event.recipes.gtceu.combustion_generator('eio_rocket_fuel')
        .inputFluids(Fluid.of('enderio:rocket_fuel', 16))
        .duration(125)
        .EUt(-32)
    event.recipes.gtceu.combustion_generator('adastra_fuel')
        .inputFluids(Fluid.of('ad_astra:fuel', 16))
        .duration(125)
        .EUt(-32)
    event.recipes.gtceu.combustion_generator('adastra_cryo_fuel')
        .inputFluids(Fluid.of('ad_astra:cryo_fuel', 4))
        .duration(125)
        .EUt(-32)
})