...
execute if entity @s[scores={dragonHealth=..5000},tag=!music] run playsound minecraft:end-fight.fight1 record @a ~ ~ ~ 1 1 1
execute if entity @s[scores={dragonHealth=..5000},tag=!music] run function endfight:dragontitle
execute if entity @s[scores={dragonHealth=..5000},tag=!music] run tag @s add music
execute if entity @s[tag=music] run stopsound @a music

#Handle becoming MAD
execute if entity @s[scores={dragonHealth=0..500},tag=!MAD] run execute in minecraft:the_end as @e[tag=crystal,limit=3] at @s run summon minecraft:end_crystal ~ ~ ~ {Tags:["crystalInit"]}
execute if entity @s[scores={dragonHealth=0..500},tag=!MAD] run stopsound @a record
execute if entity @s[scores={dragonHealth=0..500},tag=!MAD] run playsound minecraft:end-fight.fight2 record @a ~ ~ ~ 1 1 1
execute if entity @s[scores={dragonHealth=0..500},tag=!MAD] run tag @s add MAD
