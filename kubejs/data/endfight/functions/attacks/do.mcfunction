...
execute if entity @s[scores={customDragonPhase=5..},tag=!MAD] run scoreboard players set @s customDragonPhase 1
execute if entity @s[scores={customDragonPhase=9..},tag=MAD] run scoreboard players set @s customDragonPhase 1
