...
#say haha
execute positioned 0. 0 0. run summon fireball ^ ^ ^.1 {HasVisualFire:0b,ExplosionPower:4b,power:[0.0,-1.0,0.0],Tags:["fireball"],Item:{id:"minecraft:dragon_egg",Count:1b}}
