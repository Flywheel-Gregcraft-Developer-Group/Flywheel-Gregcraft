ItemEvents.tooltip(event => {
    ...
    event.add(["ends_delight:shulker_meat", "ends_delight:shulker_meat_slice", "ends_delight:roasted_shulker_meat", "ends_delight:roasted_shulker_meat_slice", "ends_delight:roasted_shulker_meat_slice", "ends_delight:stir_fried_shulker_meat", "ends_delight:grilled_shulker_block", "ends_delight:grilled_shulker", "ends_delight:shulker_omelette_mixture", "ends_delight:shulker_omelette", "ends_delight:shulker_soup", "ends_delight:ender_noodle", "ends_delight:end_barbecue_stick", "ends_delight:steamed_dragon_egg_block", "ends_delight:steamed_dragon_egg", "beachparty:raw_mussel_meat", "beachparty:cooked_mussel_meat"], Text.keybind("kubejs.misc_eating_beibei.tooltip"))
    event.add("#create:casing", Text.keybind("kubejs.misc_create_casing.tooltip"))
    event.add(["sophisticatedbackpacks:backpack", "sophisticatedbackpacks:copper_backpack", "sophisticatedbackpacks:iron_backpack", "sophisticatedbackpacks:gold_backpack", "sophisticatedbackpacks:diamond_backpack", "sophisticatedbackpacks:netherite_backpack"], Text.keybind("kubejs.backpacks.tooltip"))
})